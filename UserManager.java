 ...
 * <h2>Usage:</h2><br>
 * <ul>
 * <li>Create a new object of {@link UserManager}, add the {@link DataPackUser} as parameter.</li>
...
public class UserManager {
    ...
    private DataPackUser mUser;
    private String M_NODE_EVENT;

    public UserManager(DatabaseReference fbDatabase, String NODE_EVENT) {
        this.mDatabaseRef = fbDatabase;
        this.M_NODE_EVENT = NODE_EVENT;
    }

    public UserManager SetNewEvent(DataPackUser newUser){
        this.mUser = newUser;
        return this;
    }
    ...
    public boolean PushDataToFirebase() {
        ...
        boolean uploadResult = mDatabaseRef.getDatabase().getReference(M_NODE_EVENT).push().setValue(mUser).isSuccessful();
